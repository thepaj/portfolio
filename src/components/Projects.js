        ...
        return (
            <div className='project-page'>
                ...
                <div className='projects-container'>
                    ...
                    <a href="https://eloquent-shaw-b2166b.netlify.app/" target="_blank" rel="noopener noreferrer">
                        <Project projectTitle='Game Of Life' projectDesc='TypeScript | P5.js' image={GameOfLifeImage}/>
                    </a>
                    ...
                    <a href="https://gallant-hopper-64488a.netlify.app" target="_blank" rel="noopener noreferrer">
                        <Project projectTitle='Book Web App' projectDesc='React' image={myReadsImage}/>
                    </a>
                </div>
            </div>
        )
